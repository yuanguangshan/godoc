...
> Generated by [Sourcepack](https://github.com/yuanguangshan/sourcepack) on 2026-04-26 19:55:54

## Project Structure
```
sourcepack/
├── .claude/
│   └── settings.local.json  (7 lines)
├── .github/
│   └── workflows/
│       └── release.yml  (45 lines)
├── .gitignore  (10 lines)
├── .goreleaser.yaml  (16 lines)
├── README.md  (48 lines)
├── download-binary.js  (97 lines)
├── go.mod  (5 lines)
├── godoc.go  (707 lines)
├── godoc_test.go  (200 lines)
├── index.js  (37 lines)
├── install.sh  (72 lines)
...
gdoc -n             # 不扫描子目录
gdoc --dry-run      # 预览文件列表
gdoc -s             # 显示详细统计（文件/目录/语言/Token 分布）
...
| :--- | :---: | :---: | :---: | :---: | :---: |
| . | 10 | 1236 | 96.0% | 38.27 KB | 97.1% |
| .claude | 1 | 7 | 0.5% | 0.07 KB | 0.2% |
| .github/workflows | 1 | 45 | 3.5% | 1.08 KB | 2.7% |

### 📝 Language Breakdown
| Extension | Files | Lines | Lines % | Size | Size % |
| :--- | :---: | :---: | :---: | :---: | :---: |
| .go | 2 | 907 | 70.4% | 28.24 KB | 71.6% |
| .js | 2 | 134 | 10.4% | 4.47 KB | 11.3% |
| .sh | 1 | 72 | 5.6% | 1.72 KB | 4.4% |
| .json | 2 | 51 | 4.0% | 1.64 KB | 4.2% |
| .md | 1 | 48 | 3.7% | 1.64 KB | 4.2% |
| .yml | 1 | 45 | 3.5% | 1.08 KB | 2.7% |
| .yaml | 1 | 16 | 1.2% | 0.40 KB | 1.0% |
| .gitignore | 1 | 10 | 0.8% | 0.14 KB | 0.4% |
| .mod | 1 | 5 | 0.4% | 0.09 KB | 0.2% |
